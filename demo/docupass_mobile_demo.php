...
<head>
    <meta charset="UTF-8">
    <title>DocuPass Live Mobile Demo</title>
...
<div class="container mt-5 mb-5">
    <h1>DocuPass Live Mobile Demo</h1>
                ...
                if($_POST['email'] != ""){
                    ...
                    try{
                        ...
                        */
                        ...
                        // Create a Live Mobile verification session for this user
                        $result = $docupass->createLiveMobile();

                        // Or if you prefer Standard Mobile Module
                        ...
                        if($result['error']){
                            ...
                            /*
                             *
                             * If you are looking to embed DocuPass Mobile into your mobile App, simply embed $result['url'] inside a WebView
                             * To tell if verification has been completed monitor the WebView URL and check if it matches the URLs set in setRedirectionURL
                             * DocuPass Live Mobile currently cannot be embedded into native iOS App, you need to open it with Safari
                             *
                             * */
                        }
